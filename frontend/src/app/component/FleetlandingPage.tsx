...
function subscribeToNewsletter(Email : string) {
  ...
  return (
    <div>
      ...
      >
        <div className="w-full h-full flex flex-col items-center justify-center text-white bg-opacity-40 px-4 text-center">
          <h1 className="text-4xl md:text-5xl xl:text-7xl font-bold leading-tight mb-4">
            Control Your Fleet
            <br />
            Like Never Before
          </h1>
          <p className="text-lg md:text-2xl max-w-[600px]">
      ...
      <div className="bg-white w-full py-16 px-4 md:px-10 xl:px-32 text-center">
        <h2 className="text-3xl md:text-4xl font-semibold mb-4">Useful for business.</h2>
        ...
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              A complete platform for fleet tracking, analytics, and vehicle optimization.
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><a href="#">EV Monitoring</a></li>
              <li><a href="#">Fuel Optimization</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-2">Get the latest news & updates</p>
